javascript: (async () => {
    ...
    document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
        for (var e, t, a, o, r, i, n, s, e = document.createElement("iframe"), t = (document.body.appendChild(e),
        window.clearId = window.setInterval( () => {}
        , 0)); t--; )
    ...
    function l(e, t={}, ...o) {
        ...
        if ("object" == typeof t.style) {
            ...
            for (let o in t.style)
                e += `${o.replace(/[A-Z]/g, e => "-" + e.toLowerCase())}: ${t.style[o]}; `;
            t.style = e
        }
        for (let e in t)
            a[e] = t[e];
    ...
    ( () => {
        ...
        e.setAttribute("href", "https://fonts.googleapis.com/css?family=Nunito:400,700|Titan+One|Creepster|Satisfy|Eczar:700"),
    ...
    let c = {
        data: null,
        setItem(e, t) {
            return e.split(".").reduce( (e, o, a, n) => (e[o] = e[o] ? e[o] : {},
            ++a == n.length && (e[o] = t),
            e[o]), this.data),
        ...
        deleteItem(e) {
            return e.split(".").reduce( (e, t, o, a) => (++o == a.length && delete e[t],
            e[t]), this.data),
            localStorage.setItem("JODGUISettings", JSON.stringify(this.data)),
            this.data
        },
    ...
    try {
        for (let e of (c.data = JSON.parse(localStorage.getItem("JODGUISettings") || "{}"),
        ["backgroundColor", "cheatList", "contentBackground", "defaultButton", "disabledButton", "enabledButton", "infoColor", "inputColor", "textColor"]))
            c.data[e] && (c.setItem("theme." + e, c.data[e]),
            c.deleteItem(e))
    } catch {
        c.setData({})
    }
    let p, u, h, m, $, g, y, b, v, _ = l("div", {
        ...
        innerText: ([{ctrl: e, shift: t, alt: a, key: o},{ctrl: r, shift: i, alt: n, key: s}] = [c.data.hide || {
            ctrl: !0,
            key: "e"
        }, c.data.close || {
            ctrl: !0,
        ...
        update: ({ctrl: e, shift: t, alt: o, key: a}={
            ctrl: !0,
            key: "e"
        }, {ctrl: n, shift: r, alt: i, key: l}={
            ctrl: !0,
            key: "x"
        }) => m.innerText = `${[e && "Ctrl", t && "Shift", o && "Alt", a && a.toUpperCase()].filter(Boolean).join(" + ")} to hide | ${[n && "Ctrl", r && "Shift", i && "Alt", l && l.toUpperCase()].filter(Boolean).join(" + ")} for quick disable Click and drag here`
    }), l("div", {
        id: "credits",
        style: {
            display: "flex",
        ...
        innerHTML: "Blooket Bot",
        onclick: () => window.open("https://blooketbot.com", "_blank").focus()
    }), $ = l("div", {
        id: "controlButtons",
        style: {
            display: "flex",
        ...
        onclick: function() {
            ...
            return () => {
                for (var t of [...u.children])
                    t != $ && (e ? t.style.display = t.style._display : (t.style._display = t.style.display,
    ...
    for (let e of document.querySelectorAll("#JODGUI"))
        e.remove();
    function w(e, t, o, a) {
        let n = l("div", {
            className: "cheatButton",
            innerHTML: ("string" == typeof t ? `<img style="height: 30px; margin-right: 5px" src="${t}">` : t || "") + e,
            onclick: () => k(n.innerText, o, a)
        });
        return h.appendChild(n),
        n.onclick
    }
    function insertElemBefore(e, t, o, a, n) {
        let r = l("div", {
            className: "cheatButton",
            innerHTML: ("string" == typeof t ? `<img style="height: 30px; margin-right: 5px" src="${t}">` : t || "") + e,
            onclick: () => k(r.innerText, o, a)
        });
        return h.insertBefore(r, n),
        r.onclick
    }
    async function k(e, t, o) {
        b.innerHTML = "",
        v.firstChild.innerText = e + (o ? "" : " Cheats"),
        b.append(v);
        for (let e = 0; e < t.length; e++) {
            let {name: o, description: d, type: u, inputs: p, enabled: m, run: h, element: y} = t[e];
            if (!y) {
                let y = l("div", {
                    className: "scriptButton",
                    style: {
                        background: "toggle" == u ? m ? "var(--enabledButton)" : "var(--disabledButton)" : "var(--defaultButton)"
                    }
                }, l("div", {
                    className: "cheatName",
                    innerHTML: o
                }));
                if (y.dataset.description = d,
                y.onclick = function({target: e, key: t}) {
                    (e == y || e.classList.contains("cheatName") || "Enter" == t && e.classList.contains("cheatInput")) && (t = [...y.children].slice(1),
                    h.apply(this, t.map(e => "number" == e.type ? parseInt("0" + e.value) : "SELECT" == e.nodeName ? JSON.parse(e.value) : e.data || e.value)),
                    "toggle" == u && (y.style.background = this.enabled ? "var(--enabledButton)" : "var(--disabledButton)"),
                    C.alerts?.[0].addLog(`${"toggle" == u ? this.enabled ? "Enabled" : "Disabled" : "Ran"} <strong>${this.name}</strong>` + (p?.length ? ` with inputs: (${t.map(e => "SELECT" == e.nodeName ? e.selectedOptions[0].innerText : e.value).join(", ")})` : ""), "toggle" == u ? this.enabled ? "var(--enabledButton)" : "var(--disabledButton)" : null))
                }
                .bind(t[e]),
                p?.length)
                    for (let e = 0; e < p.length; e++) {
                        var {name: a, type: n, options: r, min: i, max: s, value: c} = p[e];
                        let t;
                        try {
                            t = await ("function" == typeof r ? r?.() : r)
                        } catch {
                            t = []
                        }
                        if ("options" == n && t?.length) {
                            let e = document.createElement("select");
                            t.forEach(t => {
                                var o = document.createElement("option");
                                o.value = JSON.stringify(t?.value || t),
                                o.innerHTML = t?.name || t,
                                e.appendChild(o)
                            }
                            ),
                            y.appendChild(e)
                            ...
                            t.classList.add("cheatInput"),
                            t.placeholder = a,
                            t.style.textAlign = "center";
                            let o = (t.readOnly = !0,
                            !1);
                            t.onclick = async () => {
                                o || (t.value = "Waiting for input...",
                                o = !0,
                                t.data = await p[e].function(e => t.value = e + "..."),
                                o = !1,
                            ...
                            (r = document.createElement("input")).classList.add("cheatInput"),
                            "number" == n && (r.type = "number",
                            r.min = i,
                            r.max = s,
                            r.value = c || (null != i ? i : 0)),
                            r.placeholder = a,
    ...
    let C = {
        global: [{
            ...
            run: function() {
                ...
                this.data = null) : (this.enabled = !0,
                this.data = setInterval( () => {
                    let {stateNode: {state: e, props: t}} = Object.values(function e(t=document.querySelector("body>div")) {
            ...
            run: function(e) {
                if (this.enabled)
                    ...
                    this.enabled = !0;
                    let {stateNode: t} = Object.values(function e(t=document.querySelector("body>div")) {
                        return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                    }())[1].children[0]._owner;
                    this.data = setInterval(e => {
                        try {
                            ...
                            if (document.querySelector("[class*='answerContainer']") || document.querySelector("[class*='typingAnswerWrapper']")) {
                                let a = 0
                                  , n = 0;
                                for (let e in t.corrects)
                                    a += t.corrects[e];
                                for (let e in t.incorrects)
                                    n += t.incorrects[e];
                                n += a;
                                let r = 0 == n || Math.abs(a / (n + 1) - e) >= Math.abs((a + 1) / (n + 1) - e);
                                if ("typing" != t.state.question.qType) {
                                    let e = document.querySelectorAll("[class*='answerContainer']");
                                    for (let t = 0; t < e.length; t++) {
                                        let a = o.correctAnswers.includes(o.answers[t]);
                                        if (r && a || !r && !a)
                                            return e[t]?.click?.()
                                    }
                                    e[0].click()
                                } else
                                    Object.values(document.querySelector("[class*='typingAnswerWrapper']"))[1].children._owner.stateNode.sendAnswer(r ? o.answers[0] : Math.random().toString(36).substring(2))
                            }
                        } catch {}
                    }
                    , 100, (e ?? 100) / 100)
            ...
            run: function(e) {
                ...
                t.remove(),
                o().stateNode.props.liveGameController.setVal({
                    path: "c/" + o().stateNode.props.client.name + "/bg",
                    val: e
                })
            }
        }, {
            ...
            inputs: [{
                name: "Box",
                type: "options",
                options: () => Array.from(document.querySelectorAll("[class*='packsWrapper'] > div")).reduce( (e, t) => (t.querySelector("[class*='blookContainer'] > img") || e.push(t.querySelector("[class*='packImgContainer'] > img").alt),
                e), [])
            }, {
                name: "Amount",
                type: "number"
            ...
            run: async function(e, t, o) {
                let a = document.createElement("iframe");
                document.body.append(a),
                window.alert = a.contentWindow.alert.bind(window),
                window.prompt = a.contentWindow.prompt.bind(window),
                window.confirm = a.contentWindow.confirm.bind(window),
                a.remove();
                let {stateNode: n} = Object.values(function e(t=document.querySelector("body>div")) {
                    return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                }())[1].children[0]._owner
                  , r = Array.from(document.querySelectorAll("[class*='packsWrapper'] > div")).reduce( (e, t) => (t.querySelector("[class*='blookContainer'] > img") || (e[t.querySelector("[class*='packImgContainer'] > img").alt] = parseInt(t.querySelector("[class*='packBottom']").textContent)),
                e), {})
                  , i = e.split(" ").map(e => e.charAt(0).toUpperCase() + e.slice(1).toLowerCase()).join(" ")
                  , l = r[i];
                if (!l)
                    return alert("I couldn't find that box!");
                let s = Math.min(Math.floor(n.state.tokens / l), t);
                if (0 == s)
                ...
                for (let e = 0; e < s; e++) {
                    await n.buyPack(!0, i),
                    c[n.state.unlockedBlook] ||= 0,
                    c[n.state.unlockedBlook]++;
                    let e = Date.now();
                    d += Date.now() - e,
                    n.setState({
                        canOpen: !0,
            ...
            run: async function(e, t, o, a) {
                ...
                n.remove();
                if (r().props.liveGameController._liveApp) {
                    var i = r().props.liveGameController._liveApp.firebase;
                    !async function() {
                        if (r().props.liveGameController._liveApp) {
                            var o = r().props.client.hostId
                              , a = parseInt(t);
                            if (a)
                                for (var n = e, i = 0; i < a; i++)
                                    await l(o, n + Math.floor(4e3 * Math.random()));
                            else
                ...
                async function l(e, t) {
                    let n = await fetch("https://fb.blooket.com/c/firebase/join", {
                        body: JSON.stringify({
                            id: e,
                            name: t
                        }),
                    ...
                    if (n.success) {
                        let r = i.initializeApp({
                            ...
                            databaseURL: n.fbShardURL
                        }, t);
                        await r.auth().signInWithCustomToken(n.fbToken);
                        let l = r.database();
                        await l.ref(`${e}/c/${t}`).set({
                            b: o,
                            bg: a
                        }),
                        C.alerts[0].addLog(`Bot ${t} joined!`)
                    } else
                        alert("Connect error: " + n.msg)
                }
            }
        }, {
            ...
            run: e => {
                const t = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode;
                t.setState({
                    loadingPack: !1,
                    openPack: !0,
                    unlockedBlook: e,
            ...
            run: async e => {
                ...
                const o = t.contentWindow.alert.bind(window);
                if (t.remove(),
                "/market" !== window.location.pathname)
                    return void o("You must be on the market page to run this cheat!");
                const a = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode
                  , n = e => new Promise(t => {
                    Array.prototype.map2 || (Array.prototype.map2 = Array.prototype.map),
                    Array.prototype.map = function() {
                        return "number" == typeof this[0]?.[1] && (t(this),
                        Array.prototype.map = Array.prototype.map2),
                        Array.prototype.map2.apply(this, arguments)
                    }
                    ;
                    var o = new a.constructor;
                    o.state.currentPack = e,
                    o.render(),
                    t(null)
                }
                );
                a.setState({
                    loadingPack: !1,
                    openPack: !0,
                    unlockedBlook: (await async function(e) {
                        let t = await n(e);
                        const o = function(e) {
                            let t = 0
                              , o = [];
                            const a = Math.floor(Math.random() * e.reduce( (e, t) => e + t, 0));
                            return e.forEach(e => (o.push(t),
                            t += e)),
                            o.map(e => a < e).findLastIndex(e => e ? 0 : 1)
                        }(t.map(e => e[1]));
                        return t[o]
                    }(e))[0],
                    newUnlock: !0,
            ...
            run: function(e) {
                ...
                (o = document.createElement("textarea")).value = t,
            ...
            run: function(e) {
                (async () => {
                    const t = e => Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode;
                    let o = document.createElement("iframe");
                    document.body.append(o);
                    let a = o.contentWindow.alert.bind(window);
                    o.remove();
                    const n = t().props.client.name;
                    t().props.client.name = e;
                    const r = await t().props.liveGameController.getDatabaseVal(`c/${n}`);
                    await t().props.liveGameController.removeVal(`c/${n}`);
                    const i = await async function(e) {
                        const o = await fetch("https://fb.blooket.com/c/firebase/join", {
                            body: JSON.stringify({
                    ...
                    i && (await t().props.liveGameController._liveApp.auth().signInWithCustomToken(i),
                    t().props.liveGameController._liveApp.auth().onAuthStateChanged(o => {
                        o.uid.split(":")[1] === e && t().props.liveGameController.setVal({
                            path: `c/${e}`,
                            val: r
                        })
                    }
            ...
            run: function(e) {
                ...
                String.prototype.inc || (String.prototype.inc = String.prototype.includes),
                String.prototype.includes = function(e) {
                    return "#" == e && this.length > 30 || String.prototype.inc.apply(this, arguments)
                }
                ;
            ...
            run: function() {
                let {state: {question: e, stage: t, feedback: o}, props: {client: {question: a}}} = Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode;
                try {
            ...
            run: async function() {
                ...
                location.href.includes("play.blooket.com")) {
                    let {t: e} = await fetch("https://play.blooket.com/api/playersessions/solo", {
                        body: JSON.stringify({
                            gameMode: "Factory",
                    ...
                    await fetch("https://play.blooket.com/api/playersessions/questions?t=" + e, {
                        credentials: "include"
                    }),
            ...
            run: function() {
                ( () => {
                    ...
                    const o = t.contentWindow.alert.bind(window);
                    if (t.remove(),
                    e.state.unlocks || e.state.blookData)
                        if (e.state.blookData) {
                            ...
                            Object.entries = function(o) {
                                ...
                                return o?.Chick && (a = o,
                                e.setState({
                                    blookData: Object.keys(a).reduce( (t, o) => (t[o] = e.state.blookData[o] || 1,
                                    t), {}),
                                    allSets: Object.values(a).reduce( (e, t) => (!e.includes(t.set) && e.push(t.set),
                                    e), [])
                                }),
                                Object.entries = t),
            ...
            run: function() {
                const encodedChars = ["\\u2f9f", "\\u4fff", "\\u4f52", "\\u0E47", "\\u0E47", "\\u0E47", "\\u0E47", "\\u0E47", "\\u0E47", "\\u0E47", "\\u4FF1", "\\u4FF2"]
                  , chars = encodedChars.map(char => eval(`"${char}"`));
                function makeLongText() {
                    return new Array(3e6).fill().map(e => chars[Math.floor(Math.random() * chars.length)]).join("")
                }
                let {props: t} = Object.values(function e(t=document.querySelector("body>div")) {
                    return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                }())[1].children[0]._owner.stateNode
            ...
            run: function() {
                ...
                e.setState = function(t, o) {
                    t?.takenBlooks || e.updater.enqueueSetState(e, t, o, "setState")
                }
            }
        }, {
            ...
            run: function() {
                (async () => {
                    const e = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode;
                    (await e.props.liveGameController.getDatabaseRef("")).on("value", t => {
                        document.querySelector("div[class*='headerTextCenter']").innerHTML = `Player Count | ${Object.keys(t.val()?.c)?.length} / ${e.props.client.plus ? 300 : 60}`
                    }
                    )
                }
                )()
            ...
            run: function() {
                ...
                a.className = "chat-box",
                document.body.appendChild(a);
                let n = document.createElement("div");
                n.className = "chat-header",
                n.textContent = "Chat",
                a.appendChild(n);
                let r = document.createElement("div");
                r.className = "chat-body",
                a.appendChild(r);
                ...
                i.addEventListener("keydown", function(o) {
                    13 === o.keyCode && (function(o) {
                        var a, n, i, s, c, d, u, p = function(e) {
                            if ("/" !== e.charAt(0))
                                return !1;
                            var t = e.split(" ")
                              , o = t[0].replace("/", "");
                        ...
                        if (p)
                            ...
                            case "cb":
                                ...
                                }, [["1234"]]]).webpack("MDrD").a)[a = Object.keys(n).find(e => a.toLocaleLowerCase() === e.toLocaleLowerCase())] ? (l("Setting blook to " + a + "!"),
                                ...
                                e().stateNode.props.client.blook = a) : l("No blook with that name was found!");
                                break;
                            case "clear":
                                r.innerHTML = "";
                                break;
                            case "dumpstate":
                                Object.keys(e().stateNode.state).map(t => {
                                    ...
                                    if (null == o)
                                        return "N/A";
                                    Array.from(o) && "object" == typeof o && (o = "[Array]"),
                                    l(t + ":" + o)
                                }
                                ).join(";");
                                break;
                            case "list":
                                e().stateNode.props.liveGameController.getDatabaseVal("c").then(e => {
                                    l("Current Players(" + Object.keys(e).length + "): " + Object.keys(e).join(","))
                                }
                                );
                                break;
                            case "tlog":
                                window.logsv = !window.logsv,
                                l("SetVal log set to " + (window.logsv ? "Enabled" : "Disabled"));
                                break;
                            case "setval":
                                i = p.args,
                                e().stateNode.props.liveGameController.setVal({
                                    path: "c/" + e().stateNode.props.client.name + "/" + i[0],
                                    val: i.slice(1, i.length).join(" ")
                                });
                                break;
                            case "setstate":
                                s = p.args,
                                ...
                                e().stateNode.setState(c),
                                l("Set Successful!");
                                break;
                            case "ahelp":
                                l("Advanced Commands: setval(sets val logged by tlog ex /setval b Chicken), tlog(toggles setval log), dumpstate(dumps react state),setstate(sets react state /setstate crypto:5 crypto2:5 etc)");
                                break;
                            case "help":
                                l("Available Commands: help(gives help),ahelp(advanced commands help), cb(changes blook /cb cow), list(lists players connected), dump(dumps all available info about a player, passwords, etc(/dump player)), clear(clears chat), code(gives game code), unlock(unlocks blook on lobby screen)");
                                break;
                            case "dump":
                                !function(t) {
                                    e().stateNode.props.liveGameController.getDatabaseVal("c/" + t).then(e => {
                                        l(null != e ? "Dump: " + JSON.stringify(e) : "Player not found!")
                                    }
                                    )
                                }(p.args.join(" "));
                                break;
                            case "unlock":
                                ...
                                }, [["1234"]]]).webpack("MDrD").a)[d = Object.keys(u).find(e => d.toLocaleLowerCase() === e.toLocaleLowerCase())] ? (e().stateNode.state.unlocks.push(d),
                                e().stateNode.forceUpdate()) : l("No blook with that name was found!");
                                break;
                            case "code":
                                l("Game Code: " + e().stateNode.props.client.hostId);
                                break;
                            default:
                ...
                var s = e().stateNode.props.liveGameController._liveApp.database()._delegate._repoInternal.server_.onDataUpdate_;
                function c(e) {
                    window.logsv && l("Path: " + e.path.split("/").splice(2, 2).join("/") + " Val: " + ("object" == typeof e.val ? JSON.stringify(e.val) : e.val))
                }
                e().stateNode.props.liveGameController._liveApp.database()._delegate._repoInternal.server_.onDataUpdate_ = function(e, t, o, a) {
                    var n, r;
                    console.log(e, t, o, a),
                    n = e,
                    null != (r = t) && n.includes("/msg") && r?.msg && (console.log(r.msg),
                    l(n.split("/")[2] + ": " + r.msg)),
                    s(e, t, o, a)
                }
                ,
            ...
            run: function() {
                ...
                !function n() {
                    let r = Math.floor(9e6 * Math.random()) + 1e6;
                    fetch(`https://fb.blooket.com/c/firebase/id?id=${r}`, {
                        method: "GET",
                        credentials: "include"
                    }).then(e => e.json()).then(i => {
                        !0 === i.success ? (console.log("Game found:", r),
                        o.innerHTML = "Game Found!",
                        a().setState({
                            client: {
                                hostId: r.toString()
                            }
                        })) : (console.log("No game found for:", r),
                        a().setState({
                            client: {
                                hostId: r.toString()
                            }
            ...
            run: function() {
                let {stateNode: e} = Object.values(function e(t=document.querySelector("body>div")) {
                    return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                }())[1].children[0]._owner;
            ...
            run: function() {
                ...
                let t = webpackJsonp.push([[], {
                  ...
                  , a = Object.values(t.c).find(e => e.exports.a?.sellBlook).exports.a.sellBlook;
                o.get("https://dashboard.blooket.com/api/users").then(async ({data: {unlocks: e}}) => {
                    if (e = Object.entries(e).filter( ([e,t]) => 1 < t && !["Legendary", "Chroma", "Mystical"].includes(webpackJsonp.push([[], {
                        1234(e, t, o) {
                            t.webpack = o
                        }
                    }, [["1234"]]]).webpack("MDrD").a[e].rarity)),
                    confirm("Are you sure you want to sell your uncommon to epic dupes?")) {
                        ...
                        alert(`(${Date.now() - n}ms) Results: ` + e.map( ([e,t]) => `    ${e} ` + (t - 1)).join(" "))
                    }
                }
                ...
                /dashboard.*\/blooks/.test(window.location.href)) {
                    if (confirm("Are you sure you want to sell your dupes? (Legendaries and rarer will not be sold)")) {
                        let {stateNode: e} = Object.values(function e(t=document.querySelector("body>div")) {
                          ...
                          , t = Date.now()
                          , o = "";
                        for (let t in e.state.blookData)
                            if (e.state.blookData[t] > 1) {
                                if (e.setState({
                                    blook: t,
                                    numToSell: e.state.blookData[t] - 1
                                }),
                                ["Legendary", "Chroma", "Mystical"].includes(document.querySelector("[class*='highlightedRarity']").innerText.trim()))
                                    continue;
                                o += `    ${t} ${e.state.blookData[t] - 1} `,
                                await e.sellBlook({
                                    preventDefault() {}
                                }, !0)
                            }
                        alert(`(${Date.now() - t}ms) Results: ${o.trim()}`)
                    }
                } else
        ...
        voyage: [{
            ...
            run: function() {
                ...
                clearInterval(this.data),
                this.data = null,
                Array.prototype.forEach.call(document.querySelectorAll(".chestESP"), e => e.remove())) : (this.enabled = !0,
                this.data = setInterval( () => {
                    (async () => {
                        let {stateNode: e} = Object.values(function e(t=document.querySelector("body>div")) {
                            return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                        ...
                        if ("heist" == e.state.stage) {
                            const e = Array.prototype.map.call(Array.prototype.slice.call(document.querySelector("[class*=prizesList]").children, 1, 4), e => e.querySelector("img").src)
                              , t = Object.values(document.querySelector("[class*=modal]"))[0].return.memoizedState.memoizedState;
                            for (const e of document.querySelectorAll("[class*=boxContent] > div"))
                                e.remove();
                            const o = Object.values(document.querySelector("[class*=modal]"))[0].return.memoizedState.next.next.memoizedState;
                            Array.prototype.forEach.call(document.querySelector("[class*=chestsWrapper]").children, (a, n) => {
                                const r = a.firstChild.firstChild;
                                if (o.includes(n))
                                    return r.style.opacity = "";
                                r.style.opacity = "0.5";
                                let i = document.createElement("div");
                                i.innerHTML = "<img src='" + e[2 - t[n]] + "' style='max-width: 75%; max-height: 75%'></img>",
            ...
            run: function() {
                ...
                t = ["d/t", "t"],
                e().stateNode.props.liveGameController.setVal({
                    path: "c/" + e().stateNode.props.client.name + "/" + t[0],
                    val: t.slice(1, t.length).join(" ")
                })
            }
        }, {
            name: "Max Levels",
            ...
            run: function(e) {
                ...
                window.prompt = t.contentWindow.prompt.bind(window),
                t.remove();
                let {stateNode: o} = Object.values(function e(t=document.querySelector("body>div")) {
                    return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                }())[1].children[0]._owner;
                o.setState({
                    doubloons: e
            ...
            run: function(e) {
                ...
                o.props.liveGameController.getDatabaseVal("c", function(t) {
                    let a = Object.entries(t || {}).reduce( (e, [t,a]) => (t != o.props.client.name && e.push({
                        name: t,
                        blook: a.b,
                        doubloons: a.d || 0
                    }),
                    e), []);
                    if (0 === a.length)
                        return o.questionsToAnswer = 1,
                        void o.randomQ();
                    let {name: n, blook: r, doubloons: i} = a.find(t => t.name == e) || a.sort( (e, t) => t.doubloons - e.doubloons)[0];
                    o.setState({
                        stage: "heist",
                        heistInfo: {
                            name: n,
            ...
            run: async function(e) {
                ...
                let {stateNode: o} = Object.values(function e(t=document.querySelector("body>div")) {
                  ...
                  , a = Object.entries(await new Promise(e => o.props.liveGameController.getDatabaseVal("c", e))).sort( (e, t) => t[1].d - e[1].d).filter(e => e[0] != o.props.client.name)
                  , n = a.find(t => t[0] == e) || a[0];
                o.props.liveGameController.setVal({
                    path: `c/${o.props.client.name}`,
                    val: {
                        b: o.props.client.blook,
                        d: n[1].d,
                        tat: `${n[0]}:${n[1].d - o.state.doubloons}`
                    }
                }),
                o.setState({
                    doubloons: n[1].d
            ...
            run: async function(e) {
                ...
                let {stateNode: o} = Object.values(function e(t=document.querySelector("body>div")) {
                  ...
                  , n = a.find(t => t[0] == e) || a[0];
                o.setState({
                    doubloons: o.state.doubloons + n[1].d
                }),
                o.props.liveGameController.setVal({
                    path: `c/${o.props.client.name}`,
                    val: {
            ...
            run: function(e) {
                ...
                t().stateNode.props.liveGameController.getDatabaseVal("c/").then(o => {
                    if (null != o) {
                        const r = Object.keys(o)[0];
                        if (e) {
                            a = ["tat", `${r}:${"1,723,583,989,363"}${n = e,
                            new Array(1700).fill(n).join(" ")}`],
                            t().stateNode.props.liveGameController.setVal({
                                path: "c/" + t().stateNode.props.client.name + "/" + a[0],
                                val: a.slice(1, a.length).join(" ")
                            })
                        } else
            ...
            run: async function(e, t) {
                let {props: o} = Object.values(function e(t=document.querySelector("body>div")) {
                    return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                }())[1].children[0]._owner.stateNode
                  , a = `Dog:${Array(500).fill(t).join(" ")}`;
                o.client.blook = a,
                o.liveGameController.setVal({
                    path: `c/${o.client.name}/b`,
                    val: a
                }),
                o.liveGameController.setVal({
                    path: `c/${o.client.name}/tat`,
                    val: `${e}:196`
                })
            }
        }],
        brawl: [{
            ...
            run: function() {
                for (let t of Object.values(document.querySelector("#app > div > div"))[1].children[0]._owner.stateNode.game.current.scene.scenes[0].physics.world.colliders._active.filter(e => e.callbackContext?.toString().includes("invulnerableTime"))) {
                    var e = t.object2;
                    let o = e.classType.prototype.start;
                    e.classType.prototype.start = function() {
                        o.apply(this, arguments),
                        this.val *= 2
                    }
                    ,
                    e.children.entries.forEach(e => e.val *= 2)
                }
            }
        }, {
            ...
            run: function() {
                for (let t of Object.values(document.querySelector("#app > div > div"))[1].children[0]._owner.stateNode.game.current.scene.scenes[0].physics.world.colliders._active.filter(e => e.callbackContext?.toString().includes("invulnerableTime"))) {
                    ...
                    ,
                    e.children.entries.forEach(e => e.speed *= .5)
                }
            }
        }, {
            name: "Instant Kill",
            ...
            run: function() {
                for (let t of Object.values(document.querySelector("#app > div > div"))[1].children[0]._owner.stateNode.game.current.scene.scenes[0].physics.world.colliders._active.filter(e => e.callbackContext?.toString().includes("invulnerableTime"))) {
                    ...
                    ,
                    e.children.entries.forEach(e => e.hp = 1)
                }
            }
        }, {
            name: "Invincibility",
            ...
            run: function() {
                var e = Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode
                  , {object1: t, object2: o} = e.game.current.scene.scenes[0].physics.world.colliders._active.find(e => e.collideCallback?.toString().includes('emit("xp"'));
        ...
        cafe: [{
            ...
            run: function(e) {
                if (this.enabled)
                    ...
                    this.data = setInterval(function() {
                        var e = Object.values(document.querySelector('body div[class*="_body"]'))[1].children[0]._owner;
                        e && e.stateNode && e.stateNode.props && e.stateNode.props.liveGameController && e.stateNode.props.liveGameController.setVal({
                            id: e.stateNode.props.client.hostId,
            ...
            run: function(e) {
                ...
                e ? (o = ["tat", e + ":tax"],
                t().stateNode.props.liveGameController.setVal({
                    path: "c/" + t().stateNode.props.client.name + "/" + o[0],
                    val: o.slice(1, o.length).join(" ")
        ...
        crypto: [{
                ...
                try {
                    ...
                    e.data = setInterval( () => {
                        ...
                        "hack" === e.stage && Array.from(document.querySelectorAll('[role="button"]._button_mrhfb_157')).forEach(t => {
                            t.textContent.trim() !== e.correctPassword.trim() ? (t.style.outlineColor = "rgba(255, 64, 64, 0.8)",
                            t.style.backgroundColor = "rgba(255, 64, 64, 0.8)",
                            t.style.textShadow = "0 0 1px #f33") : (t.style.outlineColor = "",
            ...
            run: function() {
                ...
                clearInterval(this.data),
                this.data = null) : (this.enabled = !0,
                this.data = setInterval( () => Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode.setState({
                    choices: [{
                        type: "mult",
                        val: 3,
                        rate: .075,
                ...
                try {
                    ...
                    e.data = setInterval( () => {
                        if ("hack" === ("hack" === window.location.pathname.split("/")[2] && "hack")) {
                            let {stage: e, correctPassword: t} = Object.values(document.querySelector("#app > div > div"))[1].children[1]._owner.stateNode.state;
            ...
            run: function(e) {
                ...
                t.props.liveGameController.getDatabaseVal("c", o => {
                    var a;
                    o && Object.keys(o).map(e => e.toLowerCase()).includes(e.toLowerCase()) && ([o,{cr: a}] = Object.entries(o).find( ([t]) => t.toLowerCase() == e.toLowerCase()),
                    t.setState({
                        crypto: t.state.crypto + a,
                        crypto2: t.state.crypto + a
                    }),
                    t.props.liveGameController.setVal({
                        path: "c/".concat(t.props.client.name),
                        val: {
            ...
            run: function(e) {
                ...
                const o = t.contentWindow.alert.bind(window);
                t.remove(),
                Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode.props.liveGameController.getDatabaseVal("c", t => {
                    o(t?.[e]?.p)
                }
                )
            }
        ...
        defense: [{
            ...
            run: function() {
                ...
                e.tiles.forEach(e => e.forEach( (t, o) => 3 === t && (e[o] = 0))),
                e.tiles.flatMap( (e, t) => e.map( (e, o) => 0 === e && {
                    x: o,
                    y: t
                })).filter(Boolean).sort( () => .5 - Math.random()));
                e.towers.forEach(o => {
                    var {x: a, y: n} = t.shift();
                    o.move(a, n, e.tileSize),
                    e.tiles[n][a] = 3
                }
                )
            }
            ...
            run: function() {
                let {ducks: e, tiles: t} = Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode;
                e.forEach(e => {
                    t[e.y][e.x] = 0
                }
                ),
            ...
            run: function() {
                for (var e = 0; e < 10; e++)
                    Object.values(document.querySelector("#app > div > div"))[1].children[1]._owner.stateNode.tiles[e] = Array(10).fill(0)
            }
        }, {
            name: "Remove Enemies",
        ...
        dinos: [{
                    ...
                    (async () => {
                        try {
                            ...
                            if ("excavate" === e.state.stage) {
                                e.state.choices.length || (e.state.choices = function(e) {
                                    const t = [];
                                    for (; t.length < 3; ) {
                                        const o = Math.random();
                                        let a = 0
                                ...
                                let t = 0
                                  , o = -1;
                                for (let a = 0; a < e.state.choices.length; a++) {
                                    const {type: n, val: r} = e.state.choices[a]
                                      , i = ("fossil" == n ? e.state.fossils + r * e.state.fossilMult : e.state.fossils * r) || 0;
                                    i <= t && "mult" != n || (t = i,
                                    o = a + 1)
                                }
            ...
            run: function() {
                let e = ["⁰", "¹", "²", "³", "⁴", "⁵", "⁶", "⁷", "⁸", "⁹"]
                  ...
                  , o = e => {
                    ...
                    if (e >= 1e3) {
                        ...
                        if (n < a.length) {
                            let t = "";
                            for (let o = 3; o >= 1 && (t = parseFloat((0 !== n ? e / 1e3 ** n : e).toPrecision(o)).toString(),
                            !(t.replace(/[^a-zA-Z 0-9]+/g, "").length <= 3)); o--)
                                ;
                            Number(t) % 1 != 0 && (t = Number(t).toFixed(1)),
                            o = t + a[n]
                        } else {
                            let a = e
                              , n = 0;
                ...
                this.data = setInterval( () => {
                    ...
                    t.every(e => e.querySelector("div")) || e.setState({
                        ...
                        t.forEach( (t, a) => {
                            let n = e.state.choices[a];
                            t.querySelector("div") && t.querySelector("div").remove();
                            let r = document.createElement("div");
                            r.style.color = "white",
                            r.style.fontFamily = "Macondo",
                            r.style.fontSize = "1em",
                            r.style.display = "flex",
                            r.style.justifyContent = "center",
                            r.style.transform = "translateY(25px)",
                            r.innerText = "fossil" === n.type ? `+${Math.round(n.val * e.state.fossilMult) > 99999999 ? o(Math.round(n.val * e.state.fossilMult)) : Math.round(n.val * e.state.fossilMult)} Fossils` : `x${n.val} Fossils Per Excavation`,
                            t.append(r)
                        }
                        )
                    }
            ...
            run: function() {
                ...
                const o = t.contentWindow.alert.bind(window);
                t.remove(),
                document.querySelectorAll("[class*='playerContainer']") || o("This must be run on the investigate screen!"),
                Array.from(document.querySelectorAll("[class*='playerContainer']")).forEach(async t => {
                    const o = await e.props.liveGameController.getDatabaseVal("c");
                    let a = Object.values(t)?.[0]?.key;
                    t.style.color = o[a].ic ? "#ff0000" : "#00ff00"
                }
                )
            }
        }],
        doom: [{
            ...
            run: function() {
                var e = document.createElement("iframe");
                "select" !== (e = (document.body.append(e),
                window.alert = e.contentWindow.alert.bind(window),
                e.remove(),
                Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner).stateNode).state.phase ? alert("You must be on the attribute selection page!") : e.setState({
                    myCard: {
                        ...e.state.myCard,
                        strength: 20,
                        charisma: 20,
            ...
            run: function(e) {
                var t = document.createElement("iframe");
                if (document.body.append(t),
                window.alert = t.contentWindow.prompt.bind(window),
                t.remove(),
                "/tower/battle" == window.location.pathname) {
                    t = parseInt("0" + alert("How many coins would you like?"));
                    var o = Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode;
                    try {
        ...
        factory: [{
            ...
            run: function(e) {
                ...
                o.state.blooks.length >= 10 && alert("Choose a blook to replace"),
                o.chooseBlook(JSON.parse(e))
            }
        }, {
            name: "Free Upgrades",
        ...
        fishing: [{
            ...
            enabled: !1,
            run: function() {
                const e = Object.values(document.querySelector("#app > div > div"))[1].children[1]._owner.stateNode;
                this.enabled ? (this.enabled = !1,
                e.setState({
                    isFrenzy: !1
                })) : (this.enabled = !0,
            ...
            run: function(e) {
                ...
                window.alert = t.contentWindow.alert.bind(window),
                t.remove(),
                Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner).stateNode).safe = !0,
                t.props.liveGameController.setVal({
                    path: "c/" + t.props.client.name,
                    val: {
                        b: t.props.client.blook,
            ...
            run: function(e) {
                ...
                if (!window.functionSet) {
                    var n = t().stateNode.answerNext;
                    t().stateNode.answerNext = function() {
                        var r, i;
                        t().stateNode.state.hackFish ? (t().stateNode.setState({
                            stage: "caught",
                            isCast: !1,
                            fish: {
                                name: r = e,
                                rarity: o[r].rarity,
                                weight: (i = o[r].minWeight,
                                Math.floor(Math.random() * (o[r].maxWeight - i) + i)),
                                tier: o[r].tiers[Math.floor(Math.random() * o[r].tiers.length)],
                                isSpecial: a.includes(r) && 8 > Math.floor(100 * Math.random())
                            },
                            claimReady: !1
                        }),
                        setTimeout(function() {
                        ...
                        t().stateNode.state.hackFish = null) : n.apply(this, arguments)
                    }
                }
                window.functionSet = !0,
                function(e) {
                    Object.keys(o).includes(e) ? t().stateNode.state.hackFish = e : alert("That fish does not exist!")
                }(e)
            }
        }, {
            name: "Set Weight",
        ...
        flappy: [{
            ...
            run: function() {
                ...
                for (const e of Object.values(document.querySelector("#phaser-bouncy"))[0].return.updateQueue.lastEffect.deps[0].current.config.sceneConfig.physics.world.bodies.entries)
                    if (e.gameObject.frame.texture.key.startsWith("blook")) {
                        ...
                        e.gameObject.setAlpha(this.enabled ? .5 : 1);
                        break
                    }
            }
        }, {
            ...
            run: function(e) {
                !function() {
                    if (e) {
                        var t = document.querySelector('canvas[width="320"][height="480"]');
                        if (t) {
                            var o = document.createElement("div");
                            o.innerHTML = e;
                            var a = document.createElement("div");
                            for (a.style.width = "320px",
                            a.style.height = "480px",
                            a.style.overflow = "auto",
                            a.style.boxSizing = "border-box",
                            a.style.position = t.style.position,
                            a.style.marginLeft = t.style.marginLeft,
                            a.style.marginTop = t.style.marginTop,
                            a.style.cursor = t.style.cursor,
                            a.style.backgroundColor = "#f0f0f0"; o.firstChild; )
                                a.appendChild(o.firstChild);
                            t.parentNode.replaceChild(a, t)
                        }
                        var n = document.querySelector("div._scoreText_e2c5l_7");
            ...
            run: function(e, t, o) {
                const a = Object.values(document.querySelector("#phaser-bouncy"))[0].return.updateQueue.lastEffect.deps[0].current.config.sceneConfig;
                a.birdGravity = e,
                a.birdSpeed = t,
                a.birdFlapPower = o,
                a.flap = function() {
                ...
                ,
                a.input._events.pointerdown = [],
                a.create(),
                a.input.keyboard.addKey("SPACE").on("down", e => {
                    a.flap.call(a)
                }
                )
            }
        ...
        gold: [{
            ...
            run: function() {
                ...
                clearInterval(this.data),
                this.data = null,
                e.choosePrize = e._choosePrize || e.choosePrize) : (this.enabled = !0,
                this.data = setInterval( () => {
            ...
            run: function() {
                ...
                this.data = setInterval( () => {
                    ...
                    "prize" == e.state.stage && e.props.liveGameController.getDatabaseVal("c", t => {
                        if (null == t)
                            return;
                        t = Object.entries(t);
                        let o = 0
                        ...
                        for (let a = 0; a < t.length; a++)
                            t[a][0] != e.props.client.name && t[a][1] > o && (o = t[a][1]);
                        for (let t = 0; t < e.state.choices.length; t++) {
                            const r = e.state.choices[t];
                            let i = e.state.gold;
                            "gold" == r.type ? i = e.state.gold + (r.val || 0) : "multiply" == r.type || "divide" == r.type ? i = Math.round(e.state.gold * r.val) || e.state.gold : "swap" == r.type ? i = o || e.state.gold : "take" == r.type && (i = e.state.gold + (o * r.val || 0)),
                            (i || 0) <= a || (a = i,
                            n = t + 1)
                        }
                ...
                this.data = setInterval( () => {
                    (async () => {
                        Object.values(function e(t=document.querySelector("body>div")) {
                            return Object.values(t)[1]?.children?.[0]?._owner.stateNode ? t : e(t.querySelector(":scope>div"))
                        }())[1].children[0]._owner.stateNode.state.choices.forEach( ({text: e}, t) => {
                            let o = document.querySelector(`div[class*='choice${t + 1}']`);
                            if (!o || o.querySelector("div"))
                                return;
                            let a = document.createElement("div");
                            a.style.color = "white",
            ...
            run: function() {
                ...
                e.enabled || t.enabled ? (clearInterval(e.data),
                clearInterval(t.data),
                e.data = null,
                t.data = null,
                e.enabled = !1,
                t.enabled = !1) : (e.enabled = !0,
                t.enabled = !0,
                e.data = setInterval( () => {
                        ...
                        try {
                            if ("prize" === o().stateNode.state.stage) {
                                let {choices: e} = o().stateNode.state
                                  , t = document.querySelector("div[class*='regularBody']").children[1];
            ...
            run: function(e) {
                var {props: t, state: o} = Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode;
                t.liveGameController.setVal({
            ...
            run: function() {
                ...
                window.alert = e.contentWindow.alert.bind(window),
                e.remove();
                let {props: t, state: o} = Object.values(document.querySelector("body div[id] > div > div"))[1].children[0]._owner.stateNode
                  , a = 0;
            ...
            run: function() {
                ...
                this.data = setInterval(e => {
                    let {stateNode: t} = Object.values(function e(t=document.querySelector("body>div")) {
                      ...
                      , o = Array.prototype.reduce.call(document.querySelectorAll("[class*=statContainer]"), (t, o, a) => (t[e[a]] = o,
                    t), {});
                    "choice" == t.state.phase && (Array.prototype.forEach.call(document.querySelectorAll(".choiceESP"), e => e.remove()),
                    Object.keys(t.state.guest.yes || {}).forEach(e => {
                        if (null == o[e])
                            return;
                        let a = document.createElement("div");
                        a.className = "choiceESP",
                        a.style = "font-size: 24px; color: rgb(75, 194, 46); font-weight: bolder;",
                    ...
                    Object.keys(t.state.guest.no || {}).forEach(e => {
                        ...
                        let a = document.createElement("div");
                        a.className = "choiceESP",
                        a.style = "font-size: 24px; color: darkred; font-weight: bolder;",
        ...
        extras: [{
            ...
            run: function() {
                ...
                e.remove(),
                function() {
                    let e = document.querySelectorAll("#nightify");
                    if (e.length)
            ...
            run: function() {
                var e = {
                    ...
                    gyroMove: function(t) {
                        innerWidth > innerHeight ? (e.orientation.yaw = -(t.alpha + t.beta),
                        e.orientation.pitch = t.gamma - 90 * Math.sign(90 - Math.abs(t.beta))) : (e.orientation.yaw = -(t.alpha + t.gamma),
                    ...
                    updateCSS: function() {
                        if (e.non.checked)
                            ...
                            for (var t = 0; document.querySelector("body" + " > *".repeat(t)); t++)
                                ;
                            var o = e.gap.value / t
                              , a = -Math.PI * e.sag.value / t;
                            e.cssDynamic.innerHTML = ` * { transform: translateZ(${o}px) rotateX(${a}rad); transform-style: preserve-3d; transition: transform 1s; outline: 1px solid rgba(0, 0, 0, 0.0625); ${e.flo.checked ? "overflow: visible !important;" : ""} } *:hover { transform: translateZ(${2 * o}px) rotateX(${2 * a}rad); ${e.flo.checked ? "" : "overflow: visible;"} } `
                        }
                    },
                    toggle: function() {
                    ...
                    newRange: function(t, o, a, n, r, i, l) {
                        ...
                        e.menu.appendChild(document.createElement("span")).innerHTML = o,
                        e.menu.appendChild(document.createElement("br"))
                    },
                    newCheckbox: function(t, o, a) {
                        e.menu.appendChild(t),
                        t.type = "checkbox",
            ...
            run: function(e) {
                ...
                for (var o = 1; o <= t; o++)
                    history.pushState(0, 0, o == t ? C : o.toString()),
                    o == t && (done = !0);
            ...
            run: function(e) {
                e: {
                    let o = null
                      , a = !0;
                    const {Number: n, self: r} = window
                      , i = n.parseInt(e, 10);
                    if (!1 === n.isSafeInteger(i)) {
                        r.alert("Input was not an integer");
                        break e
                    }
                    let l = 0
                      , s = 0;
                    ...
                    function t() {
                        o = r.setInterval( () => {
                            c.elementFromPoint(l, s)?.click?.()
                        }
                        , i)
                    }
                    t(),
                    c.addEventListener("mousemove", e => {
                        ({clientX: l, clientY: s} = e)
                    }
                    , {
                        passive: !0
                    }),
                    r.addEventListener("keydown", e => {
                        "s" === e.key && (a ? (r.clearInterval(o),
                        o = null) : t(),
                        a = !a)
                    }
                    )
            ...
            run: function(e, t) {
                ...
                o.type = "image/x-icon",
                o.rel = "shortcut icon",
                o.href = e || "https://www.blooket.com/favicon.ico",
        ...
        host: [{
            ...
            run: function() {
                ( () => {
                    const {stateNode: e} = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner;
            ...
            run: function() {
                ( () => {
                    const e = "/(\\[[^\\[]*\\])|(\\\\)?(LTS|LT|LL?L?L?|l{1,4})/g";
                    RegExp.prototype.tes || (RegExp.prototype.tes = RegExp.prototype.test),
                    RegExp.prototype.test = function(t) {
                        return "mm:ss" == t && this.toString() == e || RegExp.prototype.tes.apply(this, arguments)
                    }
                    ,
                    String.prototype.rep || (String.prototype.rep = String.prototype.replace),
                    String.prototype.replace = function(t, o) {
                        return "mm:ss" == this && t.toString() == e ? "HH:mm:ss" : String.prototype.rep.apply(this, arguments)
                    }
                }
                )()
            }
            ...
            run: function() {
                ...
                document.addEventListener("keydown", function(e) {
                    "Shift" === e.key && "ShiftRight" === e.code && (t.style.display = "none" === t.style.display ? "block" : "none")
                });
                const t = document.createElement("div");
                t.className = "chat-box",
                document.body.appendChild(t);
                const o = document.createElement("div");
                o.className = "chat-header",
                o.textContent = "Chat Logs (RSHIFT to hide)",
                t.appendChild(o);
                ...
                t.style.boxShadow = "0px 0px 10px rgba(0, 0, 0, 0.2)",
                ...
                var r = e().stateNode.props.liveGameController._liveApp.database()._delegate._repoInternal.server_.onDataUpdate_;
                function i(e) {
                    window.logsv && n("Path: " + e.path.split("/").splice(2, 2).join("/") + " Val: " + ("object" == typeof e.val ? JSON.stringify(e.val) : e.val))
                }
                e().stateNode.props.liveGameController._liveApp.database()._delegate._repoInternal.server_.onDataUpdate_ = function(e, t, o, a) {
                    console.log(e, t, o, a),
                    function(e, t) {
                        null != t && e.includes("/msg") && t?.msg && (console.log(t.msg),
                        n(e.split("/")[2] + ": " + t.msg))
                    }(e, t),
                    r(e, t, o, a)
                }
                ,
                window.logsv = !1;
                var l = e().stateNode.props.liveGameController.setVal;
                e().stateNode.props.liveGameController.setVal = function() {
                ...
                n("Lobbychat successfully loaded!"),
            ...
            run: function() {
                ( () => {
                    const e = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode;
                    e.onAmountUpdate = function(t) {
                        let o = e.state.settings;
                        o.amount = parseInt(t.target.value),
                        e.setState({
                            settings: o
                        })
                    }
            ...
            run: async () => {
                let e = document.createElement("iframe");
                document.body.append(e);
                const t = e.contentWindow.alert.bind(window);
                e.remove();
                const o = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode
                  , a = await o.props.liveGameController.getDatabaseVal("c");
                let n = 0;
                async function r(e) {
                    o.state.blockedUsers.includes(e) || 200 === (await fetch("https://fb.blooket.com/c/firebase/block", {
                        headers: {
                            "Content-Type": "application/json"
                        },
                        method: "POST",
                        ...
                        credentials: "include"
                    })).status && (o.state.blockedUsers.push(e),
                    n++,
                    n % parseInt("15") == 0 && await async function() {
                        return new Promise(e => {
                            setTimeout(e, 600)
                        }
                        )
                    }(),
                    C.alerts?.[0].addLog("Freed user: " + e))
                }
                o.state.blockedUsers || (o.state.blockedUsers = []);
                for (let e in a)
                    await r(e);
                t(`Freed slots: ${n}`)
            }
            ...
            run: async () => {
                const e = () => Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode;
                (await e().props.liveGameController.getDatabaseRef("")).on("value", t => e()?.getClients?.(!1))
            }
        }, {
            name: "Anti-Flood",
            ...
            run: function() {
                ...
                this.data = setInterval(async () => {
                    ...
                    try {
                        let e = Object.values(document.querySelector("#app > div > div"))[1].children[0]._owner.stateNode;
                        var t = await e.props.liveGameController.getDatabaseRef("c");
                        let o = {}
                          , a = {};
                        t.on("value", t => {
                            var n = t.val() || {}
                            ...
                            for (const e in n)
                                o[e] || (r.push(e),
                                a[e.replace(/[0-9]/g, "")] = (a[e.replace(/[0-9]/g, "")] || 0) + 1);
                            o = n;
                            for (const t of r)
                                (o[t].g || a[t.replace(/[0-9]/g, "")] > 1) && (e.props.liveGameController.blockUser(t),
                                a[t.replace(/[0-9]/g, "")]--)
                        }
                        )
                    } catch (e) {
            ...
            run: function() {
                !function() {
                    ...
                    t.name = "viewport",
                    t.content = "width=1280, initial-scale=1",
                    document.head.appendChild(t)
                }()
            }
        }, {
            ...
            run: async () => {
                const e = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode
                  , t = await e.props.liveGameController.getDatabaseVal("");
                e.props.liveGameController.setVal({
                    path: "bu",
                    val: Object.keys(t.c).reduce( (e, t) => (e[t] = 1,
                    e), t.bu ? t.bu : {})
                }),
                e.props.liveGameController.setVal({
                    path: "c",
        ...
        royale: [{
            ...
            run: e => {
                const t = Object.values(document.querySelector("#app>div>div"))[1].children[0]._owner.stateNode;
                t.startTime = performance.now() - e,
                t?.onAnswer?.(!0, t.props.client.question.correctAnswers[0])
            }
        }],
        rush: [{
            name: "Set Blooks",
            ...
            run: function() {
                var e = ""
        ...
        workshop: [{
            ...
            run: function(e) {
                ...
                t.props.liveGameController.getDatabaseVal("c", o => {
                    var a;
                    o && Object.keys(o).map(e => e.toLowerCase()).includes(e.toLowerCase()) && ([o,{t: a}] = Object.entries(o).find( ([t]) => t.toLowerCase() == e.toLowerCase()),
                    t.props.liveGameController.setVal({
                        path: "c/".concat(t.props.client.name),
                        val: {
                            b: t.props.client.blook,
                            t: a,
                            tat: o + ":swap:" + t.state.toys
                        }
                    }),
                    t.setState({
                        toys: a
        ...
        settings: [{
            ...
            inputs: [{
                type: "function",
                name: "Input",
                function: e => B( ({shift: t, ctrl: o, alt: a, key: n}) => e("" + [o && "Ctrl", t && "Shift", a && "Alt", n && n.toUpperCase()].filter(Boolean).join(" + ")))
            }],
            run: function(e) {
                c.setItem("hide", e),
        ...
        chat: [{
            element: l("div", {
                ...
                n.style.border = "none",
                n.style.backgroundColor = "#f1f1f1",
                ...
                o.appendChild(l);
                var s, c = document.createElement("input");
                function d(e) {
                    "dark" === e ? (o.style.backgroundColor = "#333",
                    ...
                    n.style.color = "#fff",
                    a.style.color = "#fff") : (o.style.backgroundColor = "#fff",
                ...
                function m(t) {
                    if (u().stateNode.props.client.hostId) {
                        var o = function(e) {
                            if ("/" === e.charAt(0)) {
                                var t = e.split(" ")
                                  , o = t[0].replace("/", "");
                        ...
                        if (o)
                            ...
                            case "cb":
                                !function(e) {
                                    ...
                                    if (e = Object.keys(t).find(t => e.toLowerCase() === t.toLowerCase()),
                                    t[e]) {
                                        p("Setting blook to " + e + "!");
                                        try {
                                            u().stateNode.props.liveGameController.setVal({
                                                id: u().stateNode.props.client.hostId,
                                                path: "c/" + u().stateNode.props.client.name,
                                                val: {
                                                    b: e
                                                }
                                            }),
                                            u().stateNode.props.client.blook = e
                                        } catch (e) {
                                            p("Failed to set blook: " + e.message)
                                        }
                                    } else
                                        p("No blook with that name was found!")
                                }(o.args.join(" "));
                                break;
                            case "clear":
                                l.innerHTML = "";
                            ...
                            case "dumpstate":
                                ...
                                n = Object.keys(a).map(e => {
                                    var t = a[e];
                                    return null != t ? (Array.isArray(t) && "object" == typeof t && (t = "[Array]"),
                                    e + ":" + t) : e + ":N/A"
                                }
                                ).join("; "),
                                p("DumpState: " + n);
                            ...
                            case "list":
                                !function() {
                                    try {
                                        u().stateNode.props.liveGameController.getDatabaseVal("c").then(e => {
                                            p("Current Players(" + Object.keys(e).length + "): " + Object.keys(e).join(","))
                                        }
                                        )
                                    } catch (e) {
                                        p("Failed to list players: " + e.message)
                                    }
                                }();
                                break;
                            case "tlog":
                                window.logsv = !window.logsv,
                                p("SetVal log set to " + (window.logsv ? "Enabled" : "Disabled"));
                                break;
                            case "setval":
                                !function(e) {
                                    try {
                                        u().stateNode.props.liveGameController.setVal({
                                            path: "c/" + u().stateNode.props.client.name + "/" + e[0],
                                            val: e.slice(1).join(" ")
                                        }),
                                        p("SetVal Successful!")
                                    } catch (e) {
                                        p("Failed to set value: " + e.message)
                                    }
                                }(o.args);
                                break;
                            case "setstate":
                                !function(e) {
                                    try {
                                        ...
                                        e.forEach(e => {
                                            var o = e.split(":");
                                            Number.isNaN(parseInt(o[1])) || (o[1] = parseInt(o[1])),
                                            t[o[0]] = o[1]
                                        }
                                        ),
                                        u().stateNode.setState(t),
                                        p("Set State Successful!")
                                    } catch (e) {
                                        p("Failed to set state: " + e.message)
                                    }
                                }(o.args);
                                break;
                            case "ahelp":
                                p("Advanced Commands: setval(sets val logged by tlog ex /setval b Chicken), tlog(toggles setval log), dumpstate(dumps react state), setstate(sets react state /setstate crypto:5 crypto2:5 etc)");
                                break;
                            case "help":
                                p("Available Commands: help(gives help), ahelp(advanced commands help), cb(changes blook /cb cow), list(lists players connected), dump(dumps all available info about a player, passwords, etc(/dump player)), clear(clears chat), code(gives game code), unlock(unlocks blook on lobby screen)");
                                break;
                            case "dump":
                                !function(e) {
                                    u().stateNode.props.liveGameController.getDatabaseVal("c/" + e).then(e => {
                                        p(null != e ? "Dump: " + JSON.stringify(e) : "Player not found!")
                                    }
                                    ).catch(e => {
                                        p("Error fetching player info: " + e.message)
                                    }
                                    )
                                }(o.args.join(" "));
                                break;
                            case "unlock":
                                !function(e) {
                                    ...
                                    t[e])
                                        try {
                                            u().stateNode.state.unlocks.push(e),
                                            u().stateNode.forceUpdate()
                                        } catch (e) {
                                            p("Failed to unlock blook: " + e.message)
                                        }
                                    else
                                        p("No blook with that name was found!")
                                }(o.args.join(" "));
                                break;
                            case "code":
                                p("Game Code: " + u().stateNode.props.client.hostId);
                                break;
                            default:
                                p("Unrecognized chat command!")
                            }
                        else
                            try {
                                u().stateNode.props.liveGameController.setVal({
                                    id: u().stateNode.props.client.hostId,
                                    path: "c/" + u().stateNode.props.client.name + "/msg",
                                    val: {
                                        i: e,
                                        msg: t
                                    }
                                ...
                                p("Failed to send message: " + e.message)
                            }
                    } else
                        p("You must be in a game to chat!");
                    var a, n
                }
                return c.type = "text",
                c.className = "chat-input",
                c.placeholder = "Type a message...",
                ...
                n.addEventListener("change", function() {
                    var e = n.value;
                    d(e),
                    localStorage.setItem("chatTheme", e)
                }),
                d(s = localStorage.getItem("chatTheme") || "light"),
                n.value = s,
                c.addEventListener("keydown", function(e) {
                    "Enter" === e.key && (m(e.target.value),
                    e.target.value = "")
                }),
                ...
                function() {
                    try {
                        var e = u().stateNode.props.liveGameController;
                        if (e && e._liveApp && e._liveApp.database) {
                            var t = e._liveApp.database()._delegate._repoInternal.server_.onDataUpdate_;
                            e._liveApp.database()._delegate._repoInternal.server_.onDataUpdate_ = function(e, o, a, n) {
                                !function(e, t) {
                                    null != t && e.includes("/msg") && t?.msg && p(e.split("/")[2] + ": " + t.msg)
                                }(e, o),
                                t(e, o, a, n)
                            }
                            ,
                            p("Lobbychat successfully loaded!")
                        } else
                            p("Make sure you're in a game!")
                    } catch (e) {
                        p("Error setting up message listener: " + e.message)
                    }
                }(),
                t
            }())
        ...
        alerts: [{
            ...
            data: {},
            updateLeaderboard(e) {
                for (var {blook: t, name: o, value: a} of (this.leaderboardEl || this.addLeaderboard(),
                ...
                e))
                    this.leaderboard.append(l("li", {
                        style: {
                            ...
                            color: o === Object.values(document.querySelector("#app>div>div"))?.[1]?.children?.[0]?._owner?.stateNode?.props?.client?.name ? "#00FF00" : "#FFFFFF"
                        }
                    }, o, l("span", {
            ...
            parseNumber(e=0) {
                ...
                if (e < 1e3)
                    return t.toString();
                var o = ["", "K", "M", "B", "T"]
                  , a = Math.floor((e.toString().length - 1) / 3);
                if (a < o.length) {
                    let n = 0;
                    for (let t = 3; 1 <= t && !((n = parseFloat((0 !== a ? e / Math.pow(1e3, a) : e).toPrecision(t))).toString().replace(/[^a-zA-Z 0-9]+/g, "").length <= 3); t--)
                        ;
                    t = (n = n % 1 != 0 ? n.toFixed(1) : n) + o[a]
                } else {
                    let o = e
                      , a = 0;
                    for (; 100 <= o; a++)
                    ...
                    let r = "";
                    var n = ["⁰", "¹", "²", "³", "⁴", "⁵", "⁶", "⁷", "⁸", "⁹"];
                    for (let e of (a + 1).toString().split(""))
                        r += n[Number(e)];
                    t = o / 10 + " × 10" + r
                }
                return t
            ...
            async connect() {
                try {
                    ...
                    let t = (await e.props.liveGameController.getDatabaseRef())?.database?.app;
                    if (!t)
                        return !1;
                    e.props.liveGameController._liveApp = t,
                    ...
                    this.connection.on("value", e => {
                        ...
                        if (t && this.diffObjects(this.data, t)) {
                            var n, r, i, l, s, c, d, u, p = this.diffObjects(this.data, t);
                            this.data = t;
                            let e = [];
                            ...
                            case "candy":
                                for (let e in p)
                                    p[e].tat?.split && ([n,r] = p[e].tat.split(":"),
                                    "swap" == r ? this.addAlert(e, o[t[e].b]?.url, "just swapped with " + n) : this.addAlert(e, o[t[e].b]?.url, `just took ${this.parseNumber(parseInt(r))} gold from ` + n));
                            ...
                            case "hack":
                                for (let e in p)
                                    p[e].tat?.split && ([i,l] = p[e].tat.split(":"),
                                    this.addAlert(e, o[t[e].b]?.url, `just took ${this.parseNumber(parseInt(l))} crypto from ` + i));
                            ...
                            case "fish":
                                for (let e in p)
                                    "Frenzy" == p[e].f ? this.addAlert(e, o[t[e].b]?.url, "just started a frenzy") : p[e].s && this.addAlert(e, o[t[e].b]?.url, `just sent a ${p[e].f} distraction`);
                            ...
                            case "dino":
                                for (let e in p)
                                    p[e].tat && ([s,c] = p[e].tat.split(":"),
                                    "true" == c ? this.addAlert(e, o[t[e].b]?.url, `just caught ${s} CHEATING!`) : this.addAlert(e, o[t[e].b]?.url, "investigated " + s));
                            ...
                            case "cafe":
                                for (let e in p)
                                    p[e].up && ([d,u] = p[e].up.split(":"),
                                    u) && this.addAlert(e, o[t[e].b]?.url, `upgraded ${d} to level ` + u);
                            ...
                            case "factory":
                                for (let e in p) {
                                    var m, h, y = p[e];
                                    y.g ? this.addAlert(e, o[t[e].b]?.url, `activated the ${a[y.g]} glitch!`) : y.s ? ([m,h] = y.s.split("-"),
                                    this.addAlert(e, o[t[e].b]?.url, `has a ${m} ${h} synergy!`)) : y.t && this.addAlert(e, o[t[e].b]?.url, "now has 10 Blooks!")
                                }
                                e = Object.entries(t).map( ([e,{b: t, ca: o}]) => ({
                                    name: e,
                                    blook: t,
            ...
            diffObjects(e, t) {
                var o, a = {};
                for (let n in e)
                    n in t && ("object" == typeof e[n] && "object" == typeof t[n] ? (o = this.diffObjects(e[n], t[n])) && 0 !== Object.keys(o).length && (a[n] = o) : JSON.stringify(e[n]) !== JSON.stringify(t[n]) && (a[n] = t[n]));
                for (let o in t)
                    o in e || (a[o] = t[o]);
    ...
    , 5e3);
    function D() {
        for (let e in _.remove(),
        clearInterval(x),
        C)
            for (let t of C[e])
                t.enabled && t.run();
        Object.keys(C).forEach(e => C[e].forEach(e => e.enabled && (e.run(),
        k(...currentMode)))),
    ...
    function A(e) {
        ...
        (t.ctrl && e.ctrlKey || !t.ctrl && !e.ctrlKey) && (t.shift && e.shiftKey || !t.shift && !e.shiftKey) && (t.alt && e.altKey || !t.alt && !e.altKey) && e.key.toLowerCase() == t.key ? (e.preventDefault(),
        _.style.display = "block" === _.style.display ? "none" : "block") : (o.ctrl && e.ctrlKey || !o.ctrl && !e.ctrlKey) && (o.shift && e.shiftKey || !o.shift && !e.shiftKey) && (o.alt && e.altKey || !o.alt && !e.altKey) && e.key.toLowerCase() == o.key && (e.preventDefault(),
        D())
    }
    function B(e, t=window) {
        return new Promise(o => {
            let a, n, r, i, l = {}, s = t => {
                ...
                n ||= t.ctrlKey,
                r ||= t.altKey,
                ["shift", "control", "alt", "meta"].includes(t.key.toLowerCase()) || (i = t.key.toLowerCase()),
                e?.({
                    shift: a,
                    ctrl: n,
                    alt: r,
            ...
            , c = e => {
                delete l[e.code],
                0 < Object.keys(l).length || (t.removeEventListener("keydown", s),
    ...
    _.addEventListener("mousemove", e => {
        ...
        y.style.opacity = "0") : (e = "scriptButton" == e.target.className ? e.target : e.target.parentElement,
        y.innerText == e.dataset.description && "0.9" == y.style.opacity || (t = e.getBoundingClientRect(),
        o = e.offsetParent.getBoundingClientRect(),
        y.innerText = e.dataset.description,
        "0" == y.style.opacity && (y.animate([{
            opacity: 0
        }, {
            opacity: .9
        }], {
